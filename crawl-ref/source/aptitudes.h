...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_GOBLIN
    APT(SP_GOBLIN,          SK_FIGHTING,       -1),
    APT(SP_GOBLIN,          SK_SHORT_BLADES,    2),
    APT(SP_GOBLIN,          SK_LONG_BLADES,     0),
    APT(SP_GOBLIN,          SK_AXES,            0),
    APT(SP_GOBLIN,          SK_MACES_FLAILS,   -1),
    APT(SP_GOBLIN,          SK_POLEARMS,       -1),
    APT(SP_GOBLIN,          SK_STAVES,         -2),
    APT(SP_GOBLIN,          SK_SLINGS,          4),
    APT(SP_GOBLIN,          SK_BOWS,            1),
    APT(SP_GOBLIN,          SK_CROSSBOWS,       1),
    APT(SP_GOBLIN,          SK_THROWING,        0),
    APT(SP_GOBLIN,          SK_ARMOUR,          1),
    APT(SP_GOBLIN,          SK_DODGING,         1),
    APT(SP_GOBLIN,          SK_STEALTH,         2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GOBLIN,          SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_GOBLIN,          SK_SHIELDS,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GOBLIN,          SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_GOBLIN,          SK_UNARMED_COMBAT, -2),
    APT(SP_GOBLIN,          SK_SPELLCASTING,   -3),
    APT(SP_GOBLIN,          SK_CONJURATIONS,   -2),
    APT(SP_GOBLIN,          SK_HEXES,          -2),
    APT(SP_GOBLIN,          SK_CHARMS,          1),
    APT(SP_GOBLIN,          SK_SUMMONINGS,     -2),
    APT(SP_GOBLIN,          SK_NECROMANCY,     -2),
    APT(SP_GOBLIN,          SK_TRANSLOCATIONS,  1),
    APT(SP_GOBLIN,          SK_TRANSMUTATIONS, -4),
    APT(SP_GOBLIN,          SK_FIRE_MAGIC,      0),
    APT(SP_GOBLIN,          SK_ICE_MAGIC,       0),
    APT(SP_GOBLIN,          SK_AIR_MAGIC,       0),
    APT(SP_GOBLIN,          SK_EARTH_MAGIC,     0),
    APT(SP_GOBLIN,          SK_POISON_MAGIC,    0),
    APT(SP_GOBLIN,          SK_INVOCATIONS,     1),
    APT(SP_GOBLIN,          SK_EVOCATIONS,      0),
